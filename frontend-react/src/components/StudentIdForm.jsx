...
export default function BookingForm() {
  const initialFormData = {
    ...
    location: "",
    category: "",
    package_type: "", // FIXED: Renamed from Package_type to package_type
    date: "",
    time: "",
    details: "",
  };
  ...
  useEffect(() => {
    ...
    if (service) {
      // Update category and load packages
      const packages = getPackages(service);
      setPackageOptions(packages);
      
      // Set form data including package_type if available
      setFormData((prev) => ({ 
        ...prev, 
        category: service,
        package_type: pkg || "" // FIXED: Use package_type
      }));
    }
  }, []);
  ...
  const handleChange = (e) => {
    ...
    if (name === "category") {
      ...
      // Reset package_type when category changes
      setFormData((prev) => ({ ...prev, package_type: "" })); // FIXED
    }
  };
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    name="package_type" // FIXED: Changed from Package_type
                    value={formData.package_type} // FIXED: Changed from Package_type
                    onChange={handleChange}
          ...
          <div className="bg-white max-w-4xl w-full rounded-2xl shadow-2xl p-6 md:p-8 lg:p-10 transition-all max-h-[90vh] overflow-y-auto"> 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
              ...
              <div className="space-y-4 p-4 border border-gray-100 rounded-xl bg-gray-50/50 shadow-sm">
                ...
                <DetailItem label="Package Type" value={formData.package_type} isPrimary={true}/> {/* FIXED */}
