...
const Dashboard = () => {
  ...
  const handleExecuteAction = async () => {
    ...
    if (result && result.success) {
        ...
        setSelectedBooking(null); // Close Details Modal (since it's no longer in the list)
    } else {
  ...
  // Calculate Revenue based on packagePrice from DB
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-2 border-t border-slate-100">
                 {selectedBooking.status === 'Confirmed' && (
                    <>
                        <button 
                            onClick={() => requestStatusUpdate(selectedBooking.userID, 'Cancelled')} 
                        ...
                        <button 
                            onClick={() => requestStatusUpdate(selectedBooking.userID, 'Completed')} 
