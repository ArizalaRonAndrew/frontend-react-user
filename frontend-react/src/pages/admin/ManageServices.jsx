...
const ManageServices = () => {
  ...
  const handleSaveServiceDetails = async () => {
    ...
    try {
      await fetch(`http://localhost:5000/api/services/${selectedService.id}`, {
        method: "PUT",
        body: formData,
      });
      fetchServices();
  ...
  const handleSavePackage = async () => {
    ...
    try {
      if (editingPackageId) {
         await fetch(`http://localhost:5000/api/services/packages/${editingPackageId}`, {
          method: "PUT",
        ...
        await fetch("http://localhost:5000/api/services/packages", {
          method: "POST",
          body: formData,
        });
